...
saveObj(valCandsKey,validators.sort(doubleSort));saveObj(kolCandsKey,[]);saveObj(valRewardKey,dist);saveObj(kolRewardKey,{});saveObj(stakeKey,Chain.msg.coinAmount);Chain.tlog('init',Chain.tx.sender,Chain.thisAddress,cfg.logic_contract);}
