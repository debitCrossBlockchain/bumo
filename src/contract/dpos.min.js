...
if(ratio!==undefined){Utils.assert(Number.isInteger(ratio)&&0<=ratio&&ratio<=100,'Invalid vote reward ratio:'+ratio+'.');proposal.rewardRatio=ratio;dist[Chain.msg.sender][2]=ratio;}
