...
> 1. 参与超级节点的申请者至少抵押500万BU（记账节点和生态节点最少质押金均为500万BU）。
...
当前涉及的分配角色包含记账节点和生态节点，候选记账节点和候选生态节点。比例为50:40:6:4，记账节点50%，生态节点40%，6%分给候选记账节点，4%分给候选生态节点。
...
> 4. 候选记账节点每年奖励（以10个为例）：25228800 * 0.06 / 10 = 151372.8 BU
...
> 6. 共建节点所获得的奖励每隔一段时间按参与者支持的份额自动计算分配，并发放到每个参与者账户。